...
export default function Signup() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 py-16" data-testid="signup-page">
      <h1 className="font-display text-4xl font-black uppercase">Create Account</h1>
      <p className="text-[#666] mt-2">Save addresses & track orders easily.</p>
      <form onSubmit={onSubmit} className="brut-card p-6 mt-6 space-y-4">
        ...
        {err && <div className="text-red-600 text-sm font-bold" data-testid="signup-error">{err}</div>}
        ...
        <div className="text-sm text-center">Have an account? <Link to="/login" className="font-bold underline">Login</Link></div>
      </form>
    </div>
  );
}
